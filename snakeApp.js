window.onload = function () {
  ...
  var selectCat = function () {
    if (chosenCategory === categories[0]) {
      catagoryName.innerHTML = "The Chosen Category Is Best Singers of All Time";
    } else if (chosenCategory === categories[1]) {
      catagoryName.innerHTML = "The Chosen Category Is Most Famous People Around The Globe";
    } else if (chosenCategory === categories[2]) {
      catagoryName.innerHTML = "The Chosen Category Is Most Populated Cities";
    }
  }  
  ...
  play = function () {
    categories = [
        ["elvis-presley", "medonna", "beyonce", "michael-jackson", "prince", "lady-gaga", "celine-dion"],
